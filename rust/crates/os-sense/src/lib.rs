...
pub use model::{
    ...
    ContextEvidenceKind, ContextFirewallPayload, ContextHealthStatus, ContextHealthSummary,
    ...
    HttpProbeStatus, HwmonSensorReading, LlmOsContext, LoadAverage, LogEntry, LogLlmSummaryOutput,
