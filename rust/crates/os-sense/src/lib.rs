...
pub use model::{
    ...
    DnsResolutionSource, DnsResolutionStatus, DnsResolverStatus, FanReading, HealthProbeResult,
    HwmonSensorReading, LoadAverage, LogEntry, LogLlmSummaryOutput, LogPattern, LogPatternEvidence,
    LogQueryResult, LogSourceStatus, LogSummary, LogSummaryBoundary, LogSummaryEvidence,
    LogSummaryMode, LogSummaryRequest, LogSummaryTimeRange, MemorySnapshot, MetricSnapshot,
    NetworkAnomalyEvidence, NetworkBaseline, NetworkBaselineEntry, NetworkConnection,
    NetworkInterfaceSnapshot, NetworkMetricsSnapshot, NetworkSnapshot, NetworkSourceStatus,
    OsContext, OsSampleMeta, PlatformInfo, ProcessAnomalyEvidence, ProcessBaseline,
    ProcessBaselineEntry, ProcessInfo, ProcessList, RateStatus, ResourceDimension,
    SensorAvailability, ServiceSnapshot, ServiceUnit, TcpProbeErrorKind, TcpProbeStage,
    TcpProbeStatus, TemperatureReading, ThermalSnapshot,
};
pub use network::{
